//
//  StandardCBUUIDKind.swift
//  BluetoothComm
//
//  Created by Monica Rondón on 2022.10.26.
//

import CoreBluetooth

// MARK: - CBUUID+StandardCBUUIDKind
public protocol StandardCBUUIDKind: Codable {
    var cbuuid: CBUUID { get }
}

public extension StandardCBUUIDKind where Self: RawRepresentable, RawValue == String {
    var cbuuid: CBUUID { CBUUID(string: rawValue) }
    var name: String { String(describing: self.self).lowercased() }
    
    init?(cbuuid: CBUUID) where Self: CaseIterable {
        self.init(rawValue: cbuuid.uuidString)
    }
 ...
 */
public enum ServiceCBUUIDKind: String, CaseIterable, StandardCBUUIDKind {
    ...
    case fitnessMachine              = "1826"
    case meshProvisioningService     = "1827"
    case meshProxyService            = "1828"
    case reconnectionConfiguration   = "1829"
    case insulinDelivery             = "182A"
}
 ...
 */
public enum CharacteristicCBUUIDKind: String, CaseIterable, StandardCBUUIDKind {
    ...
    case IEEE11073_20601RegulatoryCertificationDataList = "2A2A"
    ...
    case apparentWindSpeed                              = "2A72"
    case apparentWindDirection                          = "2A73"
    ...
    case dateOfThresholdAssessment                      = "2A86"
    case emailAddress                                   = "2A87"
    case fatHeartRateLowerLimit                         = "2A88"
    ...
    case resolvablePrivateAddressOnly                   = "2AC9"
    case fitnessMachineFeature                          = "2ACC"
    case treadmillData                                  = "2ACD"
    case crossTrainerData                               = "2ACE"
    case stepClimberData                                = "2ACF"
    case stairClimberData                               = "2AD0"
    case rowerData                                      = "2AD1"
    case indoorBikeData                                 = "2AD2"
    ...
    case fitnessMachineControlPoint                     = "2AD9"
    case fitnessMachineStatus                           = "2ADA"
    case dateUTC                                        = "2AED"
    case RCFeature                                      = "2B1D"
    case RCSettings                                     = "2B1E"
    case reconnectionConfigurationControlPoint          = "2B1F"
    case IDDStatusChanged                               = "2B20"
    case IDDStatus                                      = "2B21"
    case IDDAnnunciationStatus                          = "2B22"
    case IDDFeatures                                    = "2B23"
    case IDDStatusReaderControlPoint                    = "2B24"
    case IDDCommandControlPoint                         = "2B25"
    case IDDCommandData                                 = "2B26"
    case IDDRecordAccessControlPoint                    = "2B27"
    case IDDHistoryData                                 = "2B28"
}
...
public enum DescriptorCBUUIDKind: String, CaseIterable, StandardCBUUIDKind {
